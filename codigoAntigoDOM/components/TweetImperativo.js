...
function Tweet(conteudo, qtLikes) {
    const elementoParagrafo = document.createElement('p')
    elementoParagrafo.classList.add('tweet__conteudo')
    elementoParagrafo.textContent = conteudo

    const elementoArticle = document.createElement('article')
    elementoArticle.classList.add('tweet')
    elementoArticle.prepend(elementoParagrafo)

    // Elemento: objeto que representa um pedaço da sua tela
